...
ALTER TABLE ONLY public.github_repo ALTER COLUMN id SET DEFAULT nextval('public.github_repo_id_seq'::regclass);

--
-- Name: deployment_protection_rule_request id; Type: DEFAULT; Schema: public; Owner: admin
--

ALTER TABLE ONLY public.deployment_protection_rule_request ALTER COLUMN id SET DEFAULT nextval('public.deployment_protection_rule_request_id_seq'::regclass);
...
COPY public.sentry_installation (id, uuid, org_slug, token, refresh_token, expires_at) FROM stdin;
\.
